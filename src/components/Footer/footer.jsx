                        ...
                        <div class="row">
                            <div class="col-lg-4 col-sm-12">
                                <div class="widget widgets-company-info mb-4 mb-lg-0">
                                    ...
                                    <div class="follow-company-icon">
                                        ...
                                        <a class="social-icon-color1" href="https://www.threads.net/@haaniyagraphicsbh" target="_blank"> <img src="./insta-threads" alt="Bootstrap" width="32" height="32" /> </a>
                            ...
                            <div class="col-lg-3 col-sm-12">
                                <div class="widget widget-nav-menu">
                                        ...
                                        <div class="menu-quick-link-content">
                                        <ul class="footer-menu">
                                             <li><a href="#"><i class="bi bi-map"></i>&emsp;Haaniya Stationary WLL<br /> &emsp;&emsp; 
